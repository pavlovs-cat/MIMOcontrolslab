...
void MLC_Aero_Simulink2016a_derivatives(void)
{
  int_T is;
  int_T ci;
  static const int8_T ir[7] = { 0, 1, 2, 8, 10, 16, 18 };

  static const int8_T ir_0[7] = { 0, 1, 2, 2, 2, 2, 2 };

  static const int8_T jc[18] = { 0, 1, 0, 1, 2, 3, 4, 5, 2, 3, 0, 1, 2, 3, 4, 5,
    4, 5 };
...
RT_MODEL_MLC_Aero_Simulink201_T *MLC_Aero_Simulink2016a(void)
{
  ...
  /* External mode info */
  MLC_Aero_Simulink2016a_M->Sizes.checksums[0] = (2272736975U);
  MLC_Aero_Simulink2016a_M->Sizes.checksums[1] = (3780607104U);
  MLC_Aero_Simulink2016a_M->Sizes.checksums[2] = (1108014482U);
  MLC_Aero_Simulink2016a_M->Sizes.checksums[3] = (3194938259U);
  ...
  MLC_Aero_Simulink2016a_M->Sizes.numBlockPrms = (180);/* Sum of parameter "widths" */
